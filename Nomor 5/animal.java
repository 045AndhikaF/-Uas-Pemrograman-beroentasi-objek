...
class Animal {
    ...
    public void walk() {
        System.out.println("Berjalan menggunakan " + legs + " kaki.");
    }
...
class Cat extends Animal implements Pet {
    ...
    @Override
    public void play() {
        System.out.println("Sedang bermain menggunakan mainan kucing.");
    }
...
class Fish extends Animal implements Pet {
    ...
    @Override
    public void play() {
        System.out.println("Berenang di dalam akuarium.");
    }
